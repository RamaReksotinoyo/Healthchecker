...
# HELP healthcheck_degraded Whether the target is up but slow (1) or not (0).
# TYPE healthcheck_degraded gauge
healthcheck_degraded{target="blog"} 1
healthcheck_degraded{target="grafana"} 0
healthcheck_degraded{target="minio"} 0
# HELP healthcheck_response_seconds Response time of the last check in seconds.
# TYPE healthcheck_response_seconds gauge
healthcheck_response_seconds{target="blog"} 1.500000
